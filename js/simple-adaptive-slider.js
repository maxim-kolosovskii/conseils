var WRAPPER_SELECTOR = ".slider_wrapper",
    ITEMS_SELECTOR = ".slider_items",
    ITEM_SELECTOR = ".slider_item",
    ITEM_CLASS_ACTIVE = "slider_item_active",
    CONTROL_SELECTOR = ".slider_control",
    CONTROL_CLASS_SHOW = "slider_control-show",
    INDICATOR_WRAPPER_ELEMENT = "ol",
    INDICATOR_WRAPPER_CLASS = "slider_indicators",
    INDICATOR_ITEM_ELEMENT = "li",
    INDICATOR_ITEM_CLASS = "slider_indicator",
    INDICATOR_ITEM_CLASS_ACTIVE = "slider_indicator-active",
    SWIPE_THRESHOLD = 20,
...
(SimpleAdaptiveSlider.prototype._setActiveClass = function () {
    ...
    if (r.length)
        if (this._config.loop) for (t = 0, i = r.length; t < i; t++) r[t].classList.add(CONTROL_CLASS_SHOW);
        else
            0 === this._currentIndex
                ? (r[0].classList.remove(CONTROL_CLASS_SHOW), r[1].classList.add(CONTROL_CLASS_SHOW))
    ...
    (SimpleAdaptiveSlider.prototype._refreshExtremeValues = function () {
        ...
        for (var i = 0, e = t.length; i < e; i++) {
            ...
            n < this._minOrder
                ? ((this._minOrder = n), (this._$itemWithMinOrder = s), (this._minTranslate = parseInt(s.dataset.translate)))
                : n > this._maxOrder && ((this._maxOrder = n), (this._$itemWithMaxOrder = s), (this._minTranslate = parseInt(s.dataset.translate)));
        }
    }),
    (SimpleAdaptiveSlider.prototype._balancingItems = function () {
        if (this._balancingItemsFlag) {
            ...
            if ("next" === this._direction) {
                ...
                r.getBoundingClientRect().right < n - e && ((r.dataset.order = this._minOrder + s), (t += 100 * s), (r.dataset.translate = t), (r.style.transform = "translateX(".concat(t, "%)")), this._refreshExtremeValues());
            } else if ("prev" === this._direction) {
                var a = i.right,
                    o = this._$itemWithMaxOrder;
                (t = this._maxTranslate),
                o.getBoundingClientRect().left > a + e && ((o.dataset.order = this._maxOrder - s), (t -= 100 * s), (o.dataset.translate = t), (o.style.transform = "translateX(".concat(t, "%)")), this._refreshExtremeValues());
            }
    ...
    (SimpleAdaptiveSlider.prototype._addEventListener = function () {
        ...
        function s(t) {
            if (this._hasSwipeState) {
                ...
                this._$items.classList.remove(TRANSITION_NONE),
                    s > SWIPE_THRESHOLD ? ((this._direction = "next"), this._move()) : s < -SWIPE_THRESHOLD ? ((this._direction = "prev"), this._move()) : ((this._direction = "none"), this._move()),
                    (this._hasSwipeState = !1),
        ...
        if (
            (this._$root.addEventListener(
                ...
                function (t) {
                    var i = t.target;
                    if ((this._autoplay("stop"), i.classList.contains("slider_control"))) t.preventDefault(), (this._direction = i.dataset.slide), this._move();
